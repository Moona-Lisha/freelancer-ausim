 ...
 */
require_once ZERIF_PHP_INCLUDE . 'core/abstract/class-zerif-abstract-main.php';
require_once ZERIF_PHP_INCLUDE . 'core/customizer/class-zerif-customizer-panel.php';
require_once ZERIF_PHP_INCLUDE . 'core/customizer/class-zerif-customizer-section.php';
require_once ZERIF_PHP_INCLUDE . 'core/customizer/class-zerif-customizer-control.php';
require_once ZERIF_PHP_INCLUDE . 'core/customizer/class-zerif-customizer-partial.php';

/**
 * Class Zerif_Register_Customizer_Controls
 */
abstract class Zerif_Register_Customizer_Controls extends Zerif_Abstract_Main {
	/**
	 * WP_Customize object
	 *
	...
	private function register_controls() {
		...
		foreach ( $controls as $index => $control ) {
			...
			if ( $control->partial !== null ) {
				$this->add_partial( new Zerif_Customizer_Partial( $control->id, $control->partial ) );
			}
		}
	}
	/**
	 ...
	 *
	 * @param Zerif_Customizer_Control $control Zerif_Customizer_Control $control control to add.
	 */
	public function add_control( Zerif_Customizer_Control $control ) {
		array_push( $this->controls_to_register, $control );
	}
	/**
	 * Add the sections to load.
	 *
	 * @param Zerif_Customizer_Section $section section to add.
	 */
	public function add_section( Zerif_Customizer_Section $section ) {
		array_push( $this->sections_to_register, $section );
	}
	/**
	 * Add the panels to load.
	 *
	 * @param Zerif_Customizer_Panel $panel panel to add.
	 */
	public function add_panel( Zerif_Customizer_Panel $panel ) {
	 ...
	 *
	 * @param Zerif_Customizer_Partial $partial partial to add.
	 */
	public function add_partial( Zerif_Customizer_Partial $partial ) {
