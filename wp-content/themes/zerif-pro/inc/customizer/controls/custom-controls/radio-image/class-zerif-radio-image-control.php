 ...
 */
/**
 * Class Zerif_Customize_Control_Radio_Image
 */
class Zerif_Radio_Image_Control extends WP_Customize_Control {
	...
	/**
	 * Zerif_Radio_Image_Control constructor.
	 *
	...
	public function enqueue() {
		wp_enqueue_script( 'radio-button-script', get_template_directory_uri() . '/inc/customizer/controls/custom-controls/radio-image/script.js', array( 'jquery', 'jquery-ui-button' ), ZERIF_VERSION, true );
		wp_enqueue_style( 'radio-button-script', get_template_directory_uri() . '/inc/customizer/controls/custom-controls/radio-image/style.css', false, ZERIF_VERSION );
	}
