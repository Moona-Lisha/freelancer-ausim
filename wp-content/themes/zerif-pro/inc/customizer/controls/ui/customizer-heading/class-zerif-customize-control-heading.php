<?php
/**
 * Heading accordion customizer control
 *
 * @package zerif
 */
/**
 * Class Zerif_Customize_Control_Heading
 */
class Zerif_Customize_Control_Heading extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'zerif-heading-control-style', get_template_directory_uri() . '/inc/customizer/controls/ui/customizer-heading/heading.css', false, ZERIF_VERSION );
		wp_enqueue_script( 'zerif-heading-control-script', get_template_directory_uri() . '/inc/customizer/controls/ui/customizer-heading/heading.js', array( 'jquery' ), ZERIF_VERSION, true );
	}
