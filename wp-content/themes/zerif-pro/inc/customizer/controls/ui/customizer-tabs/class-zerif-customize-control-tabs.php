 ...
 * @access public
 */
class Zerif_Customize_Control_Tabs extends WP_Customize_Control {
	/**
	...
	public $controls;
	/**
	 * Zerif_Customize_Control_Tabs constructor.
	 *
	...
	public function enqueue() {
		wp_enqueue_style( 'zerif-tabs-control-style', get_template_directory_uri() . '/inc/customizer/controls/ui/customizer-tabs/style.css', false, ZERIF_VERSION );
		wp_enqueue_script( 'zerif-tabs-control-script', get_template_directory_uri() . '/inc/customizer/controls/ui/customizer-tabs/script.js', array( 'jquery' ), ZERIF_VERSION, true );
	}
	...
	public function content_template() {
		...
		<div class="custom-tabs-control" id="">
			<# var i = 1;
			...
			#>
			<div class="custom-customizer-tab <# if( i === 1 ){#> active <#}#>" data-tab="{{tab}}">
		...
		<# if ( data.description ) { #>
		<div class="control-description">{{{ data.description }}}</div>
		<# } #>
