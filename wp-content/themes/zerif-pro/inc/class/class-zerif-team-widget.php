	...
	class zerif_team_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array(
				...
				'description'                 => 'Zerif - Team member widget',
			);
				...
				<div class="team-member" tabindex="0">
					...
					<div class="member-details">
						...
						if ( ! empty( $instance['position'] ) ) :
							echo htmlspecialchars_decode( apply_filters( 'widget_title', $instance['position'] ) );
endif;
						?>
</div>
		...
		public function form( $instance ) {
			...
			$links = array(
				array(
					'instance_name' => 'profile_link',
					'label'         => __( 'Profile link', 'zerif' ),
				),
				array(
					'instance_name' => 'fb_link',
					'label'         => __( 'Facebook link', 'zerif' ),
				),
				array(
					'instance_name' => 'tw_link',
					'label'         => __( 'Twitter link', 'zerif' ),
				),
				array(
					'instance_name' => 'bh_link',
					'label'         => __( 'Behance link', 'zerif' ),
				),
				array(
					'instance_name' => 'db_link',
					'label'         => __( 'Dribble link', 'zerif' ),
				),
				array(
					'instance_name' => 'ln_link',
					'label'         => __( 'Linkedin link', 'zerif' ),
				),
				array(
					'instance_name' => 'gp_link',
					'label'         => __( 'Google+ link', 'zerif' ),
				),
				array(
					'instance_name' => 'pinterest_link',
					'label'         => __( 'Pinterest link', 'zerif' ),
				),
				array(
					'instance_name' => 'tumblr_link',
					'label'         => __( 'Tumblr link', 'zerif' ),
				),
				array(
					'instance_name' => 'reddit_link',
					'label'         => __( 'Reddit link', 'zerif' ),
				),
				array(
					'instance_name' => 'youtube_link',
					'label'         => __( 'YouTube link', 'zerif' ),
				),
				array(
					'instance_name' => 'instagram_link',
					'label'         => __( 'Instagram link', 'zerif' ),
				),
				array(
					'instance_name' => 'email_link',
					'label'         => __( 'Email link', 'zerif' ),
				),
				array(
					'instance_name' => 'website_link',
					'label'         => __( 'Website link', 'zerif' ),
				),
				array(
					'instance_name' => 'phone_link',
					'label'         => __( 'Phone number', 'zerif' ),
				),
			);
