	...
	public function render_content() {
		$links = array(
			...
			array(
				...
				'link' => esc_url( 'https://themeisle.com/demo/?theme=Zelle%20Pro' ),
			),
		); ?>
		...
		<div class="zerif-theme-info">
			...
			foreach ( $links as $item ) {
				?>
				<a class="button button-secondary" href="<?php echo esc_url( $item['link'] ); ?>" target="_blank"><?php echo esc_html( $item['name'] ); ?></a>
				<hr/>
				<?php
			}
			?>
