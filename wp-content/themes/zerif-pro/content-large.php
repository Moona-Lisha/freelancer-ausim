<?php
/**
 * The template used for displaying page content in template-blog-large.php
 *
 * @package zerif
 */
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'large-container' ); ?> itemtype="http://schema.org/BlogPosting" itemtype="http://schema.org/BlogPosting">
